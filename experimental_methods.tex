...
\begin{figure}[htbp]
	...
	\caption{Age distribution across experimental conditions. The histogram shows the demographic composition of participants in the \textit{Control} and \textit{Robot} conditions. Bars represent grouped counts by age bracket, with original experimental colours preserved. The distributions support the assumption of demographic comparability across conditions.}
...
\begin{figure}[htbp]
	...
	\caption{Donation amounts by experimental condition. The figure displays
		central tendency, dispersion, and outlier structure, providing the
		behavioural substrate for evaluating the deformation of the mapping
		$\alpha_E \mapsto \mathscr{P}(\delta_m)$.}
