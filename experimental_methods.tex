...
\begin{quote}
	\textbf{Does $\gamma_R$---the silent, perceptually social presence of a humanoid robot---systematically deform the evaluative mapping from $\alpha_E$ to $\mathscr{P}(\delta_m)$ across the dispositional manifold $\beta_C$?}
\end{quote}
...
\begin{center}
	\emph{The conceptual framework provided the variables.  
