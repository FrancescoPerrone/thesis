...
The guiding inquiry of this chapter is straightforward in structure yet profound in implication: \textit{can the silent presence of a humanoid robot perturb the evaluative pathway through which morally salient cues are transformed into observable action?} This question, while operationally simple, reaches beyond behavioural measurement. It probes whether the introduction of a synthetic, non-agentic entity into a morality-salient environment can deform the inferential scaffolding that underwrites moral behaviour. Framed in this way, the experiment is not a matter of testing interactional capability or technological sophistication, but of examining whether mere presence—ontologically ambiguous, semantically potent, yet behaviourally inert—can shift the translation from moral salience to moral action.
