...
\section{Prefatory Remarks: From Normative Hypothesis to Experimental Topology}

This chapter begins the empirical formalisation of a question raised by the preceding philosophical work: \textit{Can the mere presence of a synthetic, non-agentic entity deform the inferential substrate through which moral action is generated?} In moral philosophy, action is often treated as the endpoint of deliberation~\cite{Aristotle_nicomachean, Korsgaard1996, Anscombe1957} (see discussion in \cref{chap:moral_d}). Yet what is at stake here is not action alone, but the structure of the evaluative function that precedes it—an internal transformation whereby moral salience~\cite{Nussbaum2001, Korsgaard2009} becomes behavioural output.
