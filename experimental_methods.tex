...
% Prefatory Remarks: 
\section{Normative Hypothesis}

The guiding inquiry of this chapter is straightforward in structure yet profound in implication:\textit{ can the silent presence of a humanoid robot perturb the evaluative pathway through which morally salient cues are transformed into observable action?} 

This question, while operationally simple, reaches beyond behavioural measurement. It engages the broader project of understanding moral behaviour not merely as an individual trait but as an inferential process that emerges from the perception and decoding of socially meaningful signals—\textbf{a process that can, in principle, be computationally modelled}. Within the domains of social signal processing and artificial intelligence, the transformation of subtle environmental cues into behavioural outputs is treated as a mapping from informational stimuli to structured responses. By embedding a humanoid robot—ontologically ambiguous, semantically potent, yet behaviourally inert—into a morality-salient environment, this experiment asks whether such synthetic presences perturb not the content of deliberation, but the signal-to-inference architecture through which salience becomes action.
...
In other words, the question asks whether the mere fact of a robot’s presence—without communication, movement, or explicit interaction—can alter the evaluative mechanism that translates moral perception into moral behaviour. The inquiry isolates presence itself as an informational and epistemic variable, examining whether the introduction of a synthetic form into a moral field modifies not the agent’s moral reasoning, but the conditions under which moral action becomes behaviourally instantiated.

Framed as a question to preserve conceptual openness, this formulation emphasises inquiry over prediction, making it possible to derive hypotheses for empirical testing later, and reflecting the interdisciplinary aim to probe rather than presuppose the moral consequences of robotic presence.

\nextdiv
In other words, the central inquiry of this study is deceptively simple: \textit{does the mere presence of a robot alter the way human beings decide to act when confronted with a moral choice?} More concretely, we seek to determine whether individuals donate differently to a charitable cause when a humanoid robot quietly shares the room with them. The donation, measured in the tangible currency of coins left in a charity box, serves as our operational marker of prosocial behaviour. What is at stake, however, is not merely a sum of money, but the possibility that artificial companions—even without agency or intention—might subtly transform the very process by which morally salient cues are converted into human action.

To investigate this question, we devised a controlled behavioural experiment rooted in the classical Watching Eye paradigm, in which prosocial behaviour is modulated by the perceived presence of observation. Seventy-three participants were invited individually into a room under the pretext of completing personality questionnaires in exchange for monetary compensation. Unbeknownst to them, a secondary component of the setup—embedded in the room’s physical configuration—involved the presentation of a morally salient stimulus: a charity brochure prominently featuring the portrait of a child in need of medical attention. This stimulus has been shown to activate prosocial behaviour via the Watching Eye effect~\cite{Haley2005,Conty2016}.
...
Participants were randomly assigned to one of two conditions. In the Control condition, they completed the task alone. In the Robot condition, a humanoid NAO robot was present in the room, operating in autonomous life mode. Crucially, the robot was *non-interactive* and devoid of any explicit moral or communicative behaviour. Both experimental conditions preserved identical spatial and visual layouts; the sole manipulated variable was the robot’s presence—thereby isolating its ontological status as a synthetic, non-agentic entity.

Following completion of the questionnaires, each participant encountered a voluntary donation opportunity: they were offered £10 in £1 coins and could donate any portion to a real charity (Operation Smile) via an opaque box in the room. The amount donated served as the primary dependent measure of prosocial behaviour.

The results revealed a statistically significant attenuation of donation behaviour in the Robot condition. Participants donated, on average, roughly two-thirds of what was donated in the Control condition. Importantly, no significant differences in personality traits (Empathizing Quotient, Systemizing Quotient, Big Five Inventory) were found between groups, ruling out trait-based confounds and reinforcing the association between robotic presence and inferential displacement in moral behaviour.

\nextdiv
While much of the literature on moral decision-making in human–robot interaction (HRI) and human–machine interaction (HMI) foregrounds agentic interactivity as the locus of moral modulation—emphasising factors such as expressive behaviour, moral accountability framing, ostensive cues, and adaptive responsiveness~\cite{Malle2016,VanStraten2020,Arnold2017,Groom2010,Leidner2019}—the present experimental design intentionally departs from this paradigm. Rather than relying on explicit communicative exchanges or programmed ethical capacities, it examines whether mere ontological ambiguity, stripped of interactivity, can suffice to perturb the moral cognition of human observers. That is, it tests not how robots perform moral roles, but how their epistemic presence reshapes the inferential scaffolding through which \textit{moral cues become actionable}.


This divergence is not merely methodological but conceptually foundational: it permits a targeted examination of the pre-reflective susceptibility of moral cognition to \textit{ontologically ambiguous cues}—entities that do not meet the criteria for moral agency yet possess sufficient affordances to perturb inferential processes.

This question is especially salient in domains such as Social Signal Processing and HRI, where the moral and affective load of synthetic agents often exceeds their computational or ontological commitments~\cite{Vinciarelli2009,Bremner2022}. By removing interactivity while preserving perceptual and semantic features suggestive of intentionality (e.g., eyes, posture, presence), we isolate the contribution of presence alone to the evaluative architecture of moral transformation. 

In this sense, our design probes the structural vulnerability of norm-sensitive cognition to minimal but semantically encoded social signals. It thereby foregrounds a critical blind spot in prevailing models of moral decision-making with machines: namely, that moral perturbation does not require intentional content or agency, but may be triggered at the level of mere salience within a normatively saturated context.

This orientation is reinforced by evidence from De Brigard et al.~\cite{DeBrigard2021}, who demonstrate that moral judgments are systematically distorted by an agent-patient asymmetry that remains robust even when agents are stripped of contextual richness. Their findings suggest that moral cognition is inherently predisposed to track agency cues, even under conditions of minimal interactivity. It follows that the presence of an entity coded as agent-like—but behaviorally inert—may still activate heuristic processes typically reserved for moral agents. In other words, it is not the interaction per se that perturbs the moral transformation, but the cognitive availability of a \textit{putative agent}.

This proposal is consistent with work on the intentional stance~\cite{Dennett1987} and its hyperactive deployment in uncertain social environments~\cite{Guthrie1993, Waytz2010}. The synthetic entity in our experimental design is purposefully constructed to exploit the liminal space between objecthood and agency, thereby isolating the inferential mechanics that precede full agent recognition. In doing so, we move the investigative lens from \textit{action} to \textit{anticipation}—from the moral judgment of what agents do, to the moral distortion induced by what agents might represent.

Therefore, the methodological focus on \textit{mere presence} reflects a principled choice: it enables the disentanglement of interactive contingencies from the deeper, often subpersonal, cognitive priors that shape moral evaluation. In contrast to approaches that conflate moral cognition with dialogic reciprocity or overt behavioral cues, our model foregrounds the epistemic topology of moral salience: how latent structures of social attribution modulate inferential pathways prior to action, dialogue, or even conscious appraisal.

\subsection{Floridi and the Ontological Encoding of Synthetic Entities}
	
The rationale for focusing on mere presence finds a deeper formal grounding in Floridi’s theory of Levels of Abstraction (LoA)~\cite{Floridi2008,Floridi2010,Floridi2013}. In its most fundamental form, the LoA framework asserts that any inquiry—scientific, ethical, or cognitive—operates relative to a chosen abstraction interface, which selects the kinds of entities, distinctions, and informational variables that are epistemically relevant within that context. An LoA is not a metaphysical claim about what is, but a methodological filter that determines what counts as salient. As such, entities are not evaluated by reference to their intrinsic ontology, but by their semantic affordances within the information structure made visible by a given LoA.
	
From this perspective, moral agents, patients, and artificial entities are not defined ontologically per se, but functionally, relative to the informational interface through which they are accessed and interpreted. By construing moral cognition as a process that operates across LoAs, one can model the perturbation induced by synthetic entities not in terms of their intrinsic properties, but through the semantic encoding they instantiate within a given cognitive ecology.
	
\noindent
Applied not to moral cognition in the abstract, but to the transformational process through which morally salient cues are converted into observable action, Floridi’s informational ontology allows us to shift from essentialist questions of moral status (e.g., agent vs.\ non-agent) to a functionalist reading of \textbf{semantic affordances}. What matters, under this lens, is not whether the robot possesses consciousness or moral responsibility in itself, but whether—\textbf{within the operative Level of Abstraction}—it encodes features that register as morally relevant. Moral salience, then, is not anchored in the intrinsic properties of the entity, but in its \textbf{epistemic presentation}: the informational structure it instantiates at the interface between observer cognition and environmental configuration. In this view, robotic presence becomes morally consequential not by virtue of inner intentional states, but through the \textbf{perturbative role it plays in the cognitive ecology} that mediates practical reasoning.
	
\noindent
The humanoid robot deployed in this study thus occupies a structurally anomalous position. It is non-interactive, non-agentic, and yet semantically charged. At a sub-personal LoA—where perception and inferential readiness precede explicit judgement—it evokes agent-like priors via embodied features such as facial symmetry, gaze orientation, postural realism, and reactive motion. These features trigger moral anticipation without establishing moral accountability. In this respect, the robot aligns with Floridi’s notion of an artefactual moral agent~\cite{Floridi2013,FloridiSanders2004}: a non-sentient entity whose salience stems not from autonomy, but from its embeddedness within a structured \textbf{informational environment}.

\fpcom{This is more a conclusion.}
\noindent
From this standpoint, the robot’s presence constitutes a semantic perturbation: a variable that reframes, rather than directs, the evaluative pathways through which moral cues become action-relevant. The disturbance it introduces is not behavioural, nor is it socially interactive—\textbf{it is epistemic}, occurring at the level where evaluative inference is silently scaffolded. The informational architecture of the environment is thus not passively occupied, but actively reshaped.
...
In moral philosophy, action is often treated as the endpoint of deliberation~\cite{Aristotle_nicomachean, Korsgaard1996, Anscombe1957} (see discussion in \cref{chap:moral_d}). Yet what is at stake here is not action alone, but the structure of the evaluative function that precedes it—an internal transformation whereby moral salience~\cite{Nussbaum2001, Korsgaard2009} becomes behavioural output.

Still, the reader should not be misled into abandoning the focus of this chapter: moral action remains our ultimate explanandum. While salience, cognition, and interpretive modulation are examined in depth, they are not ends in themselves but components of a broader investigation into the inferential scaffolding that culminates in behaviour. The framework here is neither purely ethical nor speculative; it is practically grounded, drawing from philosophical traditions of practical reasoning and the neurocognitive models discussed in Chapter 2. Our aim is not to probe abstract normativity, but to determine whether artificial presence perturbs the transformation from moral appraisal to observable donation—a behavioural manifestation of deliberative judgement.

To interrogate this transformation empirically, we transpose the classical \textit{Watching Eye Effect}—a paradigm rooted in evolutionary psychology and moral cognition (see \cref{chap:watching_eye})—into a minimal social environment co-inhabited by a humanoid robot. While prior instantiations of this effect have relied on stylised pictorial stimuli or supernatural primes~\cite{Bateson2006,Shariff2007}, our design replaces these with an embodied artificial presence: one that is ontologically ambiguous and semiotically potent, yet neither sentient nor interactively engaged.

To formalise this inquiry, we treat moral behaviour not as a static trait, but as the outcome of a cognitive-affective transformation process. In psychological terms, this process involves the integration of perceptual moral cues, internal traits, and situational context into a behavioural response. In philosophical terms, it corresponds to the realisation of practical reasoning: a structured progression from norm perception to moral action. This transformation may be refracted by ontological ambiguity—that is, by the presence of an entity whose status as observer or agent is semantically uncertain.

In this context, we define the experimental structure as follows:
...
\begin{itemize}
	\item $\Sigma$ is the morality-salient perceptual space (e.g., visual stimuli such as the Watching Eye),
	\item $\mathscr{R}$ is the synthetic co-presence (the humanoid robot NAO),
	\item $f(\cdot)$ is the evaluative transformation function that maps environmental input to moral behaviour,
	\item and $\mathbb{E}[f(\cdot)]$ denotes the expected distribution of moral behaviour (here, donation magnitude).
\end{itemize}
...
In formal terms, the experiment operationalises the following question: does the inclusion of a synthetic co-presence (\(\mathscr{R}\)) within a morality-salient perceptual space (\(\Sigma\)) alter the expected outcome of the evaluative transformation function \(f(\cdot)\), such that the distribution of moral behaviour \(\mathbb{E}[f(\Sigma \cup \mathscr{R})]\) diverges from \(\mathbb{E}[f(\Sigma)]\)? Here, \(\Sigma\) includes affective moral cues (e.g., the Watching Eye), while \(\delta_m\) is instantiated behaviourally as charitable donation.  let us denote the probability of a deviation in moral action as a function of key experimental inputs:
...
Where:
\begin{itemize}
	\item \(\alpha_E\) encodes the environmental stimulus (visual moral cues),
	\item \(\beta_C\) denotes control variables (individual trait structure),
...
This captures the operative logic behind the empirical design: moral action is not an isolated output but a contextual function of morally salient cues, individual differences, and perturbative agents. The robotic presence is thus situated not merely as an object in the room, but as a variable that may refract the inferential lens through which moral cues are evaluated.

Moral salience, in both philosophical and psychological literature, refers to the capacity of a situation, object, or agent to present itself as morally significant—i.e., to become an object of evaluative attention in moral cognition. It operates as a kind of phenomenological filter or foregrounding mechanism, structuring what is perceived as normatively relevant prior to explicit deliberation or action. In philosophical terms, moral salience often presupposes a background of practical identity and affective receptivity, as emphasised by authors such as Korsgaard~\cite{Korsgaard2009} and Nussbaum~\cite{Nussbaum2001}, while in empirical psychology it is associated with pre-reflective processes that render certain stimuli morally “charged” or action-relevant~\cite{Greene2001, Haidt2007, Moll2005}. Within this framework, the introduction of synthetic presences may act not by directly causing actions, but by subtly reconfiguring what is attended to, felt, and evaluated as morally salient in the first place.

Before proceeding further, we articulate the central hypothesis that guides this chapter's epistemic architecture. It is not merely predictive but ontological—it concerns the kind of presence that a robot is, and what that presence does to the normative structures embedded in a shared social context.
...
This framing rejects any simplistic account of moral behaviour as noise-free reflection of trait. Instead, we position moral action as the contingent result of cognitive-affective systems operating under topological deformation~\cite{Greene2002, Haidt2001, Fedyk2017}. In this view, robotic presence is not merely a contextual feature, but a morally refractive affordance that alters the mapping between cue and action.
...
To empirically investigate whether the mere presence of a synthetic, non-agentic entity could alter the moral calculus underlying charitable behaviour, we designed an experiment that embedded participants in a controlled, minimally structured moral choice scenario. Framed as a standard personality study, the procedure unobtrusively positioned participants before a latent ethical decision without forewarning.

Each participant entered the experimental room alone and completed a series of psychometric questionnaires — the Empathizing Quotient~\cite{Baron2002}, Systemizing Quotient~\cite{Baron2003}, and the Big Five Inventory~\cite{Rammstedt2007} — and was then remunerated with £10 in cash. Unbeknownst to them, before exiting the room, participants encountered a morally salient choice: an opaque green charity box beside a large image of a child beneficiary—a visual Watching Eye stimulus—offering the opportunity to donate anonymously. The donation apparatus consisted of an opaque green collection box placed beside a prominently displayed image of a child beneficiary — a visual proxy for the Watching Eye stimulus known to activate prosocial dispositions via implicit cues of moral surveillance.

The key experimental manipulation divided participants into two groups:

\begin{itemize}
	\setlength{\itemsep}{0pt}
	\rightskip1.5cm
	\leftskip1cm
	\item In the \textbf{Control Condition}, participants completed the task alone.
	\item In the \textbf{Robot Condition}, a \textbf{Nao robot (Aldebaran Robotics)} was silently placed in the room, operating in ``autonomous life mode.'' Though behaviourally passive, the robot simulated presence through rhythmic breathing, reactive head movements, and micro-adjustments of posture—triggered only by eye contact.
\end{itemize}
...
Importantly, participants were not informed of the robot in advance, and no interaction occurred during the session. This configuration allowed us to isolate the effect of robotic presence as an embodied but non-agentic perturbation, neither fully human nor inert—ontologically ambiguous, semiotically charged.

The central empirical finding was unambiguous: participants exposed to the robot donated significantly less (£1.17 on average) than those in the control group (£1.89). This effect suggests a disruption in the inferential chain by which moral cues become action. The presence of the robot—while issuing no directive and making no explicit appeal—appeared to attenuate the moral salience of the donation context.
...
\begin{center}
	...
	The humanoid robot NAO does not act as a passive observer, but as a perturbative presence that refracts the inferential transition from moral salience to prosocial action. Its ontological ambiguity displaces the affective-empathic cue structure, thereby modulating the evaluative pathway that would otherwise lead to donation behaviour.
	\end{hypobox}
\end{center}
