...
\noindent
I confirm that I am the sole author of this thesis. With the exception of background sections that review existing literature and established theoretical frameworks (chapters~\ref{chap:lit_rev}, \ref{chap:tools_new}, \ref{chap:ethics_s} and the non-original contextual material in chapters~\ref{chap:moral_primer} and
\ref{chap:general_discussion}), all research reported here is my own independent work.
