...
estimation—a structurally coherent pattern appears:
\bigskip
\noindent
\begin{center}
	\begin{leftbar}
...
\bigskip
\noindent
The effect is modest in magnitude, yet \textbf{consistent across analytic approaches}, 
directionally stable, and shaped by the cognitive--affective structure of the observer.
...
What the analyses ultimately reveal is simple in structure and deep in
implication: a synthetic body, silent and behaviourally inert, can alter the
conditions under which moral salience becomes action. In the formalism, this
appears as a deformation of the evaluative mapping $f(\alpha_E,\beta_C,\gamma_R)$;
in the empirical record, as a modest but reliable attenuation of prosocial
behaviour. At the operative Level of Abstraction, it is encountered not as a
mechanism but as a presence that reorganises what becomes foreground, what
withdraws, and what calls for response.

\medskip
\noindent
This is what it means for synthetic presence to modulate the topology of moral
salience: the evaluative field is not fixed but susceptible to subtle shifts in
its perceptual and normative contours. The effect is small, but its lesson is
large. Our intuitive moral appraisals take shape within environments that now
include artificial agents, and those environments quietly shape us in return.
The chapters that follow build on this insight, turning from empirical
demonstration to its conceptual and ethical consequences.
